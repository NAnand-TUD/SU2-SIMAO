...
inline void CGeometry::ReadCSD_Mesh(CConfig *config) {}

// inline unsigned long CGeometry::getnModes(void) {return 0;}
//   
// inline su2double CGeometry::getModeVector(unsigned short iMode, unsigned short val_iDim, unsigned long iPoint) {return 0.;}
//   
// inline su2double CGeometry::getFrequency(unsigned short iMode) {return 0.;}
//     
// inline unsigned long CGeometry::getnCSD_Points(void) {return 0;}
// 
// inline su2double CGeometry::getRefLength(void) {return 0.;}


// inline su2double CRBFMapping::getWedlandC2(su2double radius) {
