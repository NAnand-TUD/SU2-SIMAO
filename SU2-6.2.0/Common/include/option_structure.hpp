...
enum ENUM_SOLVER {
  ...
  FEM_MODAL = 14,                       /*!< \brief Definition of a CSD solver. */
...
enum ENUM_FSI_STRUC_PROBLEM {
  ...
  FEM_MODAL_SFSI = 14,          /*!< \brief Structural equations of motion (modal form) for the FSI problem */
};
...
enum RUNTIME_TYPE {
  ...
  RUNTIME_MODAL_SYS = 23,		   /*!< \brief One-physics case, the code is solving the CSD equation. */
};
...
const int MODAL_SOL = 0;	/*!< \brief Position of the Modal Structural equation in the solution solver array. */
 ...
 * \brief type of time integration schemes
 */
// enum ENUM_TIME_INT_MODAL {
//   RK2 = 1,                  /*!< \brief Support for implementing Rung-Kutta 2nd order method. */
//   RK4 = 2,                  /*!< \brief Support for implementing Rung-Kutta 4th order method. */
//   EXPONENTIAL = 3           /*!< \brief Support for implementing another implicit exponential matrix method. */
// };
// static const map<string, ENUM_TIME_INT_MODAL> Time_Int_Map_MODAL = CCreateMap<string, ENUM_TIME_INT_MODAL>
// ("RK2", RK2)
// ("RK4", RK4)
// ("EXPONENTIAL", EXPONENTIAL);
...
enum ENUM_DYN_TRANSFER_METHOD {
  INSTANTANEOUS = 1,   /*!< \brief No ramp, load is transfered instantaneously. */
  POL_ORDER_1 = 2,     /*!< \brief The load is transfered using a ramp. */
  POL_ORDER_3 = 3,     /*!< \brief The load is transfered using an order 3 polynomial function */
  POL_ORDER_5 = 4,     /*!< \brief The load is transfered using an order 5 polynomial function */
  SIGMOID_10 = 5,      /*!< \brief The load is transfered using a sigmoid with parameter 10 */
  SIGMOID_20 = 6       /*!< \brief The load is transfered using a sigmoid with parameter 20 */
};
...
enum ENUM_DYNAMIC {
  ...
  FORCED = 3,		      /*!< \brief Use a time stepping strategy for forced motions. */
