...
void CConfig::SetConfig_Options(unsigned short val_iZone, unsigned short val_nZone) {
 ...
 /* DESCRIPTION: default value for AIR */
  ...
  addEnumOption("TIMESTEP_HEAT", Kind_TimeStep_Heat, Heat_TimeStep_Map, MINIMUM);
    /* DESCRIPTION: Time discretization */
//   addEnumOption("TIME_DISCRE_MODAL", Kind_TimeIntScheme_MODAL, Time_Int_Map_MODAL, RK2);
  ...
  * objective.  \ingroup Config   */
  ...
  addUnsignedLongOption("NUMBER_OF_MODES", NumberOfModes, 1);
  ...
  *  Options: NO, YES \ingroup Config */
  ...
  addEnumOption("DYNAMIC_ANALYSIS", Dynamic_Analysis, Dynamic_Map, STATIC);
    /* DESCRIPTION: Dynamic or static structural analysis */
    addEnumOption("DYNAMIC_METHOD", Dynamic_Method, Dynamic_Map, STATIC);
...
//        &&
//        (Kind_GridMovement[ZONE_0] != AEROELASTIC3D)
    ))
    Grid_Movement = false;
...
void CConfig::SetOutput(unsigned short val_software, unsigned short val_izone) {
  ...
  bool csd = (Kind_Solver == FEM_MODAL);
...
unsigned short CConfig::GetContainerPosition(unsigned short val_eqsystem) {
  ...
  switch (val_eqsystem) {
    ...
    case RUNTIME_MODAL_SYS:     return MODAL_SOL;
...
void CConfig::SetGlobalParam(unsigned short val_solver,
  ...
  switch (val_solver) {
    ...
    case FEM_ELASTICITY: case FEM_MODAL:
      ...
      if (val_system == RUNTIME_MODAL_SYS) {
        SetKind_ConvNumScheme(NONE, NONE, NONE, NONE, NONE, NONE);
        SetKind_TimeIntScheme(Kind_TimeIntScheme_MODAL);
      }
      break;
  }
}
