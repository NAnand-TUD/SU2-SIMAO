...
// CInterpolator::CInterpolator(CGeometry ****geometry_container, CConfig **config, unsigned int iZone) {
//   
//   size = SU2_MPI::GetSize();
//   rank = SU2_MPI::GetRank();
// 
...
//   donorZone  = iZone;
// 
//   donor_geometry  = geometry_container[donorZone][INST_0][MESH_0]; //check if these are the relevant markers
// 
//   /*--- Initialize transfer coefficients between the zones ---*/
//     /* Since this is a virtual function, call it in the child class constructor  */
//   //Set_TransferCoeff(targetZone,donorZone,config);
...
//TODO: define problem using 1zone and CSD mesh
// CRadialBasisFunction::CRadialBasisFunction(CGeometry ****geometry_container, CConfig **config) :  CInterpolator(geometry_container, config, iZone) {
// 
//   /*--- Initialize transfer coefficients between the zones ---*/
//   Set_TransferCoeff(config);
// 
