...
public:
   ...
   * \param[in] Iteration - Current iteration.
   */
  virtual void Modal_Iteration(CGeometry ****geometry, CSolver *****solver_container, CNumerics ******numerics_container,CConfig **config, unsigned short RunTime_EqSystem, unsigned long Iteration, unsigned short iZone, unsigned short iInst);
  /*! 
   * \brief A virtual member.
   * \param[in] geometry - Geometrical definition of the problem.
   * \param[in] solver_container - Container vector with all the solutions.
...
/*!
 * \class CModalIntegration
 * \brief Class for doing the numerical integration of the structural model.
 * \author R. Sanchez.
 */
class CModalIntegration : public CIntegration {
public:
   ...
   * \param[in] config - Definition of the particular problem.
   */
  CModalIntegration(CConfig *config);

  /*!
   * \brief Destructor of the class.
   */
  ~CModalIntegration(void);
   ...
   * \param[in] Iteration - Current iteration.
   */
  void Modal_Iteration(CGeometry ****geometry, CSolver *****solver_container, CNumerics ******numerics_container, CConfig **config, unsigned short RunTime_EqSystem, unsigned long Iteration, unsigned short iZone, unsigned short iInst);
