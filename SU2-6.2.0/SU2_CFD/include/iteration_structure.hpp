...
/*!
 * \class CModalIteration
 * \brief Class for driving an iteration of structural dynamics analysis.
 * \author S. Marques
 * \version 6.2.0 "Falcon"
 */
class CModalIteration : public CIteration {
public:
   ...
   * \param[in] config - Definition of the particular problem.
   */
  CModalIteration(CConfig *config);

  /*!
   * \brief Destructor of the class.
   */
  ~CModalIteration(void);
   ...
   * \param[in] val_iZone - zone of the problem.
   */
  void Solve(COutput *output, CIntegration ****integration_container,
             CGeometry ****geometry_container,
             CSolver *****solver_container,
             CNumerics ******numerics_container,
             CConfig **config_container,
