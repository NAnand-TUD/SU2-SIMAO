...
protected:
  ...
  **Cvector;       /*!< \brief Auxiliary structure for computing gradients by least-squares */
  ...
  passivedouble *Inlet_Data; /*!< \brief Auxiliary structure for holding the data values from an inlet profile file. */
    ...
    // CSD  vars
//     su2double** generalizedDisplacement; /*!< \brief Modal displacemen. */
//     su2double** generalizedVelocity;
//     su2double* modalForce, *modalForceLast;
...
//     void Aeroelastic3D(CSurfaceMovement *surface_movement, CGeometry *geometry, CConfig *config);
//     
//     void solveStructure(CGeometry *geometry, CConfig *config);
//     
//     void ComputeFluidModalForce(CGeometry *geometry);
// 
//     void setGeneralizedDisplacement(unsigned short iMode, su2double val_disp);
// 
//     void setGeneralizedVelocity(unsigned short iMode, su2double val_disp);
// 
...
//    */
//   void Aeroelastic3D(CSurfaceMovement *surface_movement, CGeometry *geometry, CConfig *config, unsigned long ExtIter);
//   
  /*!
   * \brief Prepares and solves the aeroelastic equations.
   * \param[in] surface_movement - Surface movement classes of the problem.
 ...
 *  \date 25 April, 2019.
 */
class CModalSolver : public CSolver {
private:
...
//   void Set_MPI_Solution_Pred_Old(CGeometry *geometry, CConfig *config);
    ...
    /*!
    * \brief Reads in mode shapes, Set residuals to zero.
    * \param[in] geometry - Geometrical definition of the problem.
    * \param[in] solver_container - Container vector with all the solutions.
    * \param[in] config - Definition of the particular problem.
    * \param[in] iRKStep - Current step of the Runge-Kutta iteration.
...
//     void Initialize_As_Matrix(unsigned short nMode, unsigned short nInst);
    ...
    * \param[in] iMode - mode number.
    * \param[out] omega[iMode].
    */
//     su2double getFrequency(unsigned short iMode);
    
    /*!
    * \brief Returns the n. of modes retained in the CSD model.
    * \param[out] nModes].
    */
//     unsigned long getnModes(void);

    /*!
    * \brief Returns the mode shape value for (iMode,iDim,iPoint)
    * \param[in] iMode - mode number.
    * \param[in] iMode - spatial dimension.
    * \param[out] mode value.
    */
//     su2double getModeVector(unsigned short iMode, unsigned short val_iDim, unsigned long iPoint);
    
    /*!
    * \brief Returns the number of points in CSD mesh
    * \param[in] none
    * \param[out] n. of points in CSD mesh.
    */
//     unsigned long getnCSD_Points(void);
    
//     su2double getRefLength(void);
    
    // void read_modes(string val_modes_filename); // -- part of preprocessing

	/*! \brief project force onto mode shapes
	 */
// 	void ComputeFluidModalForce(su2double *f);
	
    /*! \brief solve structural eq. of motion (RK scheme)
     */
//     void SolveModalStructure(su2double *qsol, su2double *f);
    
//     void SolveStatic(su2double *qsol, su2double *f);
    
//     void updateCSDNodalPositions(CGeometry *geometry);
    
//     unsigned short getnModes(void);
...
//   void BC_Clamped(CGeometry *geometry, CSolver **solver_container, CNumerics *numerics, CConfig *config, unsigned short val_marker);
   ...
   * \param[in] val_marker - Surface marker where the boundary condition is applied.
   */
//   void BC_Clamped_Post(CGeometry *geometry, CSolver **solver_container, CNumerics *numerics, CConfig *config, unsigned short val_marker);
...
//   void BC_DispDir(CGeometry *geometry, CSolver **solver_container, CNumerics *numerics, CConfig *config, unsigned short val_marker);
   ...
   * \param[in] val_marker - Surface marker where the boundary condition is applied.
   */
//   void BC_Normal_Displacement(CGeometry *geometry, CSolver **solver_container, CNumerics *numerics, CConfig *config, unsigned short val_marker);
   ...
   * \param[in] val_marker - Surface marker where the boundary condition is applied.
   */
//   void BC_Normal_Load(CGeometry *geometry, CSolver **solver_container, CNumerics *numerics, CConfig *config, unsigned short val_marker);
   ...
   * \param[in] val_marker - Surface marker where the boundary condition is applied.
   */
//   void BC_Dir_Load(CGeometry *geometry, CSolver **solver_container, CNumerics *numerics, CConfig *config,unsigned short val_marker);
   ...
   * \param[in] val_marker - Surface marker where the boundary condition is applied.
   */
//   void BC_Sine_Load(CGeometry *geometry, CSolver **solver_container, CNumerics *numerics, CConfig *config,unsigned short val_marker);
   ...
   * \param[in] val_marker - Surface marker where the boundary condition is applied.
   */
//   void BC_Damper(CGeometry *geometry, CSolver **solver_container, CNumerics *numerics, CConfig *config,unsigned short val_marker);
...
//   su2double GetFSI_Residual(void);
   ...
   * \param[in] flow_geometry - Definition of the particular problem.
   */
//   void PredictStruct_Displacement(CGeometry **fea_geometry,CConfig *fea_config,CSolver ***fea_solution);
   ...
   * \param[in] fea_geometry - Definition of the particular problem.
   */
//   void Update_StructSolution(CGeometry **fea_geometry,CConfig *fea_config, CSolver ***fea_solution);
