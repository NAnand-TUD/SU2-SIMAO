...
//  cout<<"val_var "<<val_var<<" nDim "<<nDim<<endl;
  for (unsigned short iDim = 0; iDim < nDim; iDim++) {
//      cout << Point_Max_Coord_BGS[val_var][iDim] << endl;
>>>>>>> 430a80f7f37a57904fa513e7190cee8c568385f2
...
inline void CSolver::SetiInst(unsigned short val_inst){ }
...
// 
// inline su2double CModalSolver::GetRes_FEM(unsigned short val_var) { return Conv_Check[val_var]; }
// 
// inline su2double CModalSolver::GetTotal_CFEA() { return Total_CFEA; }
// 
// inline void CModalSolver::SetTotal_CFEA(su2double cfea) { Total_CFEA = cfea; }
// 
// inline su2double CModalSolver::GetFSI_ConvValue(unsigned short val_index){ return FSI_Conv[val_index]; }
// 
// inline su2double CModalSolver::GetTotal_OFRefGeom(void){ return Total_OFRefGeom; }
// 
// inline su2double CModalSolver::GetTotal_OFRefNode(void){ return Total_OFRefNode; }
// 
// inline su2double CModalSolver::GetTotal_OFVolFrac(void){ return Total_OFVolFrac; }
// 
// inline void CModalSolver::SetForceCoeff(su2double val_forcecoeff_history) { ForceCoeff = val_forcecoeff_history; }
// // 
// inline void CModalSolver::SetRelaxCoeff(su2double val_relaxecoeff_history) { RelaxCoeff = val_relaxecoeff_history; }
// // 
// inline void CModalSolver::SetFSI_Residual(su2double val_FSI_residual) { FSI_Residual = val_FSI_residual; }
// // 
// inline su2double CModalSolver::GetForceCoeff(void) { return ForceCoeff; }
// // 
// inline su2double CModalSolver::GetRelaxCoeff(void) { return RelaxCoeff; }
// // 
// inline su2double CModalSolver::GetFSI_Residual(void) { return FSI_Residual; }
