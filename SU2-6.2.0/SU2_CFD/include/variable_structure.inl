...
inline void CVariable::Add_DeltaVelSolution(unsigned short val_var, su2double val_solution) { }
...
inline su2double CVariable::GetModeVector(unsigned short val_mode, unsigned short val_dim){ return 0.0; }
  
inline void CVariable::SetModeVector(unsigned short val_mode, unsigned short val_dim, su2double val){ }
...
inline void CModalVariable::SetSolution_Pred(unsigned short val_var, su2double val_solution_pred) { Solution_Pred[val_var] = val_solution_pred;  }
...
inline su2double CModalVariable::GetSolution_Pred(unsigned short val_var) { return Solution_Pred[val_var]; }

inline su2double *CModalVariable::GetSolution_Pred_Old(void) { return Solution_Pred_Old; }
...
inline su2double CModalVariable::GetModeVector(unsigned short val_mode, unsigned short val_dim){
    return modeShape[val_dim + val_mode*nDim];
}

inline void CModalVariable::SetModeVector(unsigned short val_mode, unsigned short val_dim, su2double val){
    modeShape[val_dim + val_mode*nDim] = val;
}
inline su2double *CModalVariable::GetSolution_Vel(void) { return Solution_Vel; }

inline su2double CModalVariable::GetSolution_Vel(unsigned short val_var) { return Solution_Vel[val_var]; }

inline su2double *CModalVariable::GetSolution_Vel_time_n(void) { return Solution_Vel_time_n; }
