...
void CStructuralIntegration::Structural_Iteration(CGeometry ****geometry, CSolver *****solver_container,
  ...
  solver_container[iZone][iInst][MESH_0][SolContainer_Position]->Preprocessing(geometry[iZone][iInst][MESH_0], solver_container[iZone][iInst][MESH_0],config[iZone], numerics_container[iZone][iInst][MESH_0][SolContainer_Position], MESH_0, Iteration, RunTime_EqSystem, false);
...
CModalIntegration::CModalIntegration(CConfig *config) : CIntegration(config) { }

CModalIntegration::~CModalIntegration(void) { }

void CModalIntegration::Modal_Iteration(CGeometry ****geometry, CSolver *****solver_container,
                                                  CNumerics ******numerics_container, CConfig **config, unsigned short RunTime_EqSystem, unsigned long Iteration, unsigned short iZone, unsigned short iInst) {

  unsigned short SolContainer_Position = config[iZone]->GetContainerPosition(RunTime_EqSystem);

  /*--- Preprocessing ---*/
  solver_container[iZone][iInst][MESH_0][SolContainer_Position]->Preprocessing(geometry[iZone][iInst][MESH_0], solver_container[iZone][iInst][MESH_0],config[iZone], numerics_container[iZone][iInst][MESH_0][SolContainer_Position], MESH_0, Iteration, RunTime_EqSystem, false);  //dummy function


    /*--- Space integration ---*/
    // WARNING: redundant for modal equations
    // Space_Integration_FEM(geometry[iZone][iInst][MESH_0], solver_container[iZone][iInst][MESH_0], numerics_container[iZone][iInst][MESH_0][SolContainer_Position],config[iZone], RunTime_EqSystem, Iteration);
...
//   solver_container[iZone][iInst][MESH_0][SolContainer_Position]->RK2(geometry[iZone][iInst][MESH_0], solver_container[iZone][iInst][MESH_0],config[iZone]);
  ...
  /*--- Convergence strategy ---*/
//   switch (RunTime_EqSystem) {
//     case RUNTIME_MODAL_SYS: 
//         Convergence_Monitoring_FEM(geometry[iZone][iInst][MESH_0], config[iZone], solver_container[iZone][iInst][MESH_0][SolContainer_Position], Iteration); break;
//   }
}
