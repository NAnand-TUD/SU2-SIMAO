...
/* -------------------------------- CSD --------------------------------- */
CModalVariable::CModalVariable(void) : CVariable() {
    
    FlowTraction        = NULL;    // Nodal traction due to the fluid (fsi)
    FlowTraction_time_n = NULL;    // Nodal traction due to the fluid (fsi) at time n (for gen-alpha methods)
    Solution_Vel        = NULL;
    Solution_Vel_time_n = NULL;   
    modeShape           = NULL;
...
CModalVariable::CModalVariable(su2double *val_csd, unsigned short val_nDim, unsigned short val_nVar, unsigned short val_nModes, CConfig *config) : CVariable(val_nDim, val_nVar, config) {
  
    unsigned short iVar;
    
    FlowTraction        = NULL;
    FlowTraction_time_n = NULL;
    Solution_Vel        = NULL;
    Solution_Vel_time_n = NULL;
    Solution_Pred       = NULL;
    Solution_Pred_Old   = NULL;
...
CModalVariable::~CModalVariable(void) {
    ...
    if (FlowTraction_time_n != NULL) delete [] FlowTraction_time_n;
    if (Solution_Vel_time_n != NULL) delete [] Solution_Vel_time_n;
    if (FlowTraction != NULL) delete [] FlowTraction;
    if (Solution_Vel != NULL) delete [] Solution_Vel;
    if (modeShape != NULL) delete [] modeShape;
